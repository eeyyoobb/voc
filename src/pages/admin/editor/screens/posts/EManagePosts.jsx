...
import { deletePost, getOwnPosts } from "../../../../../services/index/posts";
...
const ManagePosts = () => {
  const {
    ...
    dataQueryFn: () => getOwnPosts(userState.userInfo.id,searchKeyword, currentPage),
    dataQueryKey: "posts",
      ...
      {postsData?.data.map((post) => (
        <tr>
          ...
          <td className="px-5 py-5 text-sm bg-white border-b border-gray-200 space-x-5">
            ...
            <Link
              to={`/editor/posts/manage/edit/${post?.slug}`}
