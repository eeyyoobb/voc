...
const Hero = () => {
  ...
  return (
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row bg-gray-600">
      <div className="mt-10 lg:w-1/2">
        ...
        <div className="text-dark-light mt-4 text-center md:text-xl lg:text-base xl:text-xl lg:text-left">
